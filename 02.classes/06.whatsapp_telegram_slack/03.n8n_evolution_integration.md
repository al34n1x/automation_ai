# 🤖 README — Integración de **n8n** con Evolution API (WhatsApp Agent)
...
- Habilita el webhook cambiado del estado del campo **Enabled**
...
> Para este laboratorio, solo necesitamos **`MESSAGES_UPSERT`**. Si por alguna razón habilitando el webhook, se habilitan las otras configuraciones, deshabilítalas para evitar conflictos.
