...
# 🚀 AI Automation – SENPAI Academy

Welcome to the official GitHub repository for the course **"AI Automation"** by [SENPAI Academy](https://www.senpaiacademy.com/curso/productividad-con-ia).
...
1. Clone or download the repository:
   ```bash
   git clone https://github.com/al34n1x/automation_ai.git
   ```
...
- Anyone curious about using AI with foundational technical skills
